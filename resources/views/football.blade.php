            ...
            <div class="p-2 order-1 order-md-1 bgWhite mx-auto wid70 wid100Mobile" id="bodyVal">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img class="wid16px" src="{{ asset('icons/football/france.png') }}" alt=""> France: League 1</td>
                            </tr>
                            <tr class="boldFour">
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img src="{{ asset('icons/football/england.png') }}" alt=""> England: Premier League</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                                <td class="fontSize10px">Tip</td>
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img src="{{ asset('icons/football/spain.png') }}" alt=""> Spain: La liga</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                                <td class="fontSize10px">Tip</td>
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img src="{{ asset('icons/football/italy.png') }}" alt=""> Italy: Seria A</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                                <td class="fontSize10px">Tip</td>
