    ...
    <div class="wid80 wid100Mobile p-lg-3 bgWhite mx-auto rounded">
        <div class="d-flex flex-wrap justify-content-center">
            <div class="p-2 mx-auto order-2 order-md-0 bgSocials wid30 wid100Mobile">
                <p class="fontSize12px my-3 boldFive">Today Free Games</p>
            ...
            <div class="p-2 order-1 order-md-1 bgWhite mx-auto wid70 wid100Mobile" id="bodyVal">
                        ...
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img class="wid16px"
                                        src="{{ asset('icons/football/france.png') }}" alt=""> France: League
                                    1</td>
                            </tr>
                            <tr class="boldFour">
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img
                                        src="{{ asset('icons/football/england.png') }}" alt=""> England:
                                    Premier League</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img src="{{ asset('icons/football/italy.png') }}"
                                        alt=""> Italy: Seria A</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                                <td class="fontSize10px">Tip</td>
                ...
                <div class="mt-2">
                    ...
                    <a href="https://t.me/+v8J2LHM5RJEzZjhk"
...
<script>
    $(document).ready(function() {
        $.ajax({
            ...
            type: 'GET',
            success: (data) => {
                $("#europeGames").html(data)
            }
        })
        $.ajax({
            url: '/loadAmericaGames',
            type: 'GET',
            success: (data) => {
                $("#americaGames").html(data)
            }
        })
        $.ajax({
            url: '/loadSpainGames',
        ...
        $('#bodyVal').data('old-state', $('#bodyVal').html());
        $("#reset").click(() => {
            $('#bodyVal').html($('#bodyVal').data('old-state'));
        })
    })
