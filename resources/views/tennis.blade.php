...
<main class="marginTopSmallNavLong" style="background-color:  #F5F5F5;">
    ...
    <div class="mx-auto m-2 wid80 wid100Mobile d-block higt125px" style="overflow: hidden;">
        <a href="{{ $bannerLong->url }}" target="_blank"><img src="{{ 'files/'.$bannerLong->name }}" class="wid100" alt=""></a>
    </div>
    @else
    <!-- <div class="mx-auto m-2 wid80 wid100Mobile d-block higt125px" style="overflow: hidden;">
        ...
        <div class="d-flex flex-wrap justify-content-center">
            <div class="p-2 mx-auto order-2 order-md-0 bgSocials wid30 wid100Mobile">
                ...
                <div class="d-block wid100 mx-auto mb-3">
                    ...
                    <a href="/" onclick="event.preventDefault(); loadGames(10);" class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img src="https://media-1.api-sports.io/football/leagues/10.png" alt="" class="wid16px"> International Friendlies </a>
                    <a href="/" onclick="event.preventDefault(); loadGames(36);" class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img src="{{ asset('icons/football/africa.png') }}" alt=""> African Nations Cup Qualifiers</a>
