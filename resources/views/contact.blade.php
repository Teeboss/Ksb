        ...
        <div class="d-flex flex-wrap justify-content-center align-items-center ">
            ...
            <div class="wid50 wid100Mobile rounded bgWhite p-4">
                ...
                <form method="POST" action="{{ route('contact.us.store') }}" id="contactUSForm">
                    ...
                    <div class="my-4">
                        <input type="email" name="email" id="formGroupExampleInput2" placeholder="Email"
                    ...
                    <div class="my-4">
                        <input type="text" name="subject" id="formGroupExampleInput2" placeholder="Subject"
                            class="form-control fontSize14px" id="">
                    ...
                    <div class="my-4">
                        <textarea name="message" id="" cols="30" rows="5" class="form-control fontSize14px"
                    ...
                    <div class="my-4">
                        <button type="submit"
                            class="rounded-pill p-2 wid100 borderNone white boldSix fontSize18px bgBlueKsbTwo">Submit</button>
                    </div>
