...
<main class="marginTopSmallNavLong p-3" style="background-color:  #F5F5F5;">
    <div class="mx-auto m-2 wid70 wid100Mobile d-block higt125px" style="overflow: hidden;">
        <a href="{{ $bannerLong->url }}"><img src="{{ asset('files/'.$bannerLong->name) }}" class="wid100" alt=""></a>
    </div>
