        ...
        <div class="d-flex flex-wrap justify-content-center">
            <div class="p-2 mx-auto order-2 order-md-0 bgSocials wid30 wid100Mobile">
                ...
                <div class="d-block wid100 mx-auto mb-3">
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(12);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/usa.png') }}" alt=""> USA NBA</a>
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(117);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/spain.png') }}" alt=""> Spain Liga ACB</a>
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(13);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/usa.png') }}" alt=""> USA WNBA</a>
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(242);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/italy.png') }}" alt=""> Italy Seria A</a>
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(104);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/turkey.png') }}" alt=""> Turkiye Super Ligi</a>
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(40);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/garmany.png') }}" alt=""> Garmany BBL</a>
                    <a href="/" onclick="event.preventDefault(); loadGamesBasket(45);"
                        class="wid100 bodyA d-block boldFive p-2 marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/greece.png') }}" alt=""> Greece BasketLeague</a>
                ...
                <div class="d-block wid100 mx-auto mb-1" id="countries">
                    <a href="1"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/au.jpg') }}" alt="" class="wid16px"> Australia</a>
                    <a href="3"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/at.jpg') }}" class="wid16px" alt=""> Austria</a>
                    <a href="5"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/us.jpg') }}" class="wid16px" alt=""> USA</a>
                    <a href="6"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
                    ...
                    <a href="9"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/ca.jpg') }}" alt="" class="wid16px"> Canada</a>
                    <a href="11"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
                            src="{{ asset('icons/football/cn.jpg') }}" alt="" class="wid16px"> China</a>
                    <a href="10"
                        class="wid100 bodyA d-block boldFive p-2 country marginY fontSize12px bgWhite"><img
            ...
            <div class="p-2 order-1 order-md-1 bgWhite mx-auto wid70 wid100Mobile" id="bodyVal">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img src="{{ asset('icons/football/spain.png') }}"
                                        alt=""> Spain: Liga ACB</td>
                            </tr>
                            <tr class="boldFour">
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img src="{{ asset('icons/football/cn.jpg') }}"
                                        class="wid16px" alt=""> China: CBA</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                                <td class="fontSize10px">Tip</td>
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img class="wid16px"
                                        src="{{ asset('icons/football/us.jpg') }}" alt=""> USA: NBA</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
                                <td class="fontSize10px">Tip</td>
                ...
                <div class="table-responsive shadow mb-4">
                    <table class="table table-hover">
                        <thead>
                            <tr class="bgShaddyWhite">
                                <td colspan="8" class="white"><img class="wid16px"
                                        src="{{ asset('icons/football/ukraine.png') }}" alt=""> Ukraine: FBU
                                    SuperLeague</td>
                            </tr>
                            <tr class="boldFour">
                                <td colspan="4" class="fontSize10px">Events</td>
