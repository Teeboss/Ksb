...
<head>
    ...
    <meta property="og:image" content="{{ asset('icons/metaImgUrl.jpg') }}" />
...
<body>
    <nav class="fixed-top bgBlackKsb deskTop p-2">
        <div class="wid70 d-block mx-auto">
            <div class=" d-flex justify-content-between">
                <a href="/"><img src="{{ asset('icons/iconNav.png') }}" alt=""></a>
                <div class="d-flex justify-content-between wid50 align-items-center ">
                    ...
                    <div>
                        ...
                        @else
                        <a href="" class="fontSize14px navA ms-4" data-bs-toggle="modal" data-bs-target="#myAccountModal">myAccount</a>
    ...
    <nav class="fixed-top bgBlackKsb mobile p-2">
        <div class="wid50Mobile d-block mx-auto">
            <div class="d-flex my-3 justify-content-between align-items-center">
                <img src="{{ asset('icons/iconNav.png') }}" class="wid24px" alt="">
                <div class="d-flex align-items-center">
                    ...
                    @else
                    <a href="" class="fontSize12px white me-2">myAccount</a>
                    <span class="white">|</span>
