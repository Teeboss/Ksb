            ...
            <div class=" d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-between wid65 align-items-center ">
                    ...
                    <a href="#" target="_blank" class="fontSize14px navA"
                        rel="noopener noreferrer">English(US)</a>
                    <div>
                        @guest
                            <a href="" class="fontSize14px navA me-3" data-bs-toggle="modal"
                                data-bs-target="#loginModal">Login</a>
                            <button class="fontSize14px navAButton py-2 px-3" data-bs-toggle="modal"
                                data-bs-target="#registrationModal">
                                Register
                            </button>
                        @else
                            <a href="" class="fontSize14px navA ms-4" data-bs-toggle="modal"
                                data-bs-target="#myAccountModal">{{ Auth::user()->email }} </a>
            ...
            <div class="d-flex wid70 mt-4 justify-content-between">
                @guest
                    <a href="/" class="boldFive fontSize16px navA {{ request()->is('/') ? 'navActive' : '' }}"
                        id="homeId">Home</a>
                    <a href=""
                        class="boldFive fontSize16px navA {{ request()->is(['football', 'fixture/*']) ? 'navActive' : '' }}"
                        data-bs-toggle="modal" data-bs-target="#loginModal">
                        <!-- <img src="{{ asset('icons/SoccerBall.png') }}" class="me-1" alt=""> -->
                        Football</a>
                    <a href="/basketball"
                        class="boldFive fontSize16px navA {{ request()->is(['basketball', 'basketballfixture']) ? 'navActive' : '' }}"
                        data-bs-toggle="modal" data-bs-target="#loginModal">
                        Basketball</a>
                    <a href="/tennis"
                        class="boldFive fontSize16px navA {{ request()->is(['tennis', 'tennisfixture']) ? 'navActive' : '' }}"
                        data-bs-toggle="modal" data-bs-target="#loginModal">
                        Tennis</a>
                    <a href="/livescores"
                        class="boldFive fontSize16px navA {{ request()->is(['livescores', 'livescores']) ? 'navActive' : '' }}"
                        data-bs-toggle="modal" data-bs-target="#loginModal">
                        LiveScores</a>
                    <a href="/subscription"
                ...
                @else
                    ...
                    <a href="/football"
                        ...
                        Football</a>
                    <a href="/basketball"
                        class="boldFive fontSize16px navA {{ request()->is(['basketball', 'basketfix/*']) ? 'navActive' : '' }}">
        ...
        <div class="wid100Mobile d-block mx-auto">
            <div class="d-flex my-3 justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    @guest
                        <a href="" class="fontSize12px white me-2" data-bs-toggle="modal"
                            data-bs-target="#loginModal">Login</a>
                        <span class="white">|</span>
                        <a href="" class="fontSize12px navAMobile ms-2" data-bs-toggle="modal"
                            data-bs-target="#registrationModal">Register</a>
                    @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="wid80 my-3 mx-auto">
                        ...
                        <form action="{{ route('login.post') }}" method="POST" id="handleAjaxLogin">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="mb-2 form-check">
                                    ...
                                    <label class="form-check-label shaddyWhite fontSize12px"
                                        for="exampleCheck1">Remember Me</label>
                                </div>
                                <a href="/forgotpassword" class="redKsb noneTextDecoration fontSize12px">forget your
                                    password?</a>
                            </div>
                            <div class="my-4">
                                <button type="submit"
                        ...
                        <p class="text-center fontSize16px ">Don't have an account? <a data-bs-toggle="modal"
                                data-bs-target="#registrationModal"
                                class="noneTextDecoration boldSix blackKsb pointers">Sign Up</a></p>
                    </div>
                </div>
                        ...
                        @section('content')
                            <form action="{{ route('registration.post') }}" method="POST" id="handleAjax">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="mb-2 form-check">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label shaddyWhite fontSize12px" for="exampleCheck1">I
                                            Accept KsbBet <a href="" class="blackKsb fontSize12px">Terms and
                                                Conditions</a></label>
                                    </div>
                                ...
                                <div class="my-4">
                                    <button type="submit"
                                        class=" rounded-pill borderNone p-2 wid100 white boldSix fontSize18px bgBlueKsbTwo">Proceed</button>
                                </div>

                            </form>
                            <p class="text-center fontSize16px">I have an account? <a
                                    class="noneTextDecoration boldSix blackKsb pointers" data-bs-toggle="modal"
                                    data-bs-target="#loginModal">Sign in</a></p>
                        </div>
                    </div>
                    <!-- <div class="modal-footer">
                                                                                                                                                                                                                                                                                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
