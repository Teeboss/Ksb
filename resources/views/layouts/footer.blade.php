<footer class="bgBlueKsb wid100Mobile p-2">
    <div class="wid80 d-none d-lg-block pt-4 mx-auto">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-between">
                <a href="/contact" class="m-3 noneTextDecoration fontSize16px white d-block boldFour">Contact Us</a>
                <a href="/news" class="m-3 noneTextDecoration fontSize16px white d-block boldFour">Blog</a>
                <!-- <img src="{{ asset('icons/beware.png') }}" class="m-3 " alt="" style="height: 18px;"> -->
                <a href="#" class="m-3 noneTextDecoration fontSize16px white boldFour  d-block">Terms & Conditions</a>
                <a href="#" class="m-3 noneTextDecoration fontSize16px white boldFour  d-block">Privacy Policy</a>
            </div>
            <div>
    ...
    <div class="d-block pt-2 wid20Mobile mx-auto d-sm-none">
        ...
        <div class="d-flex justify-content-center">
            <a href="/contact" class="m-3 fontSize10px white boldFour noneTextDecoration d-block noWrap ">Contact Us</a>
            <a href="/news" class="m-3 fontSize10px white boldFour noneTextDecoration d-block noWrap ">Blog</a>
            <a href="#" class="m-3 fontSize10px white boldFour noneTextDecoration d-block noWrap">Terms & Conditions</a>
            <a href="#" class="m-3 fontSize10px white boldFour noneTextDecoration d-block noWrap">Privacy Policy</a>
        </div>
