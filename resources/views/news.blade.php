        ...
        @foreach ($newses as $news)
            <div class="d-flex flex-wrap p-2 bgWhite my-3">
                ...
                <div class=" align-self-center col-11 col-sm-7">
                    ...
                    <a href="/news/{{ $news->id }}" class="bodyAA fontSize12px">Read more <img class="wid16px"
                            src="{{ asset('icons/arrow.png') }}" alt=""></a>
                </div>
            </div>
        @endforeach
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <img src="{{ asset('icons/telegramModal.gif') }}" class="wid100 pointers" alt="Image"
                        onclick="location.href='https://t.me/+v8J2LHM5RJEzZjhk'">
                </div>
            </div>
        </div>
    </div>
