...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link noWrap" href="/newsUpload">News Posts</a>
                        </li>
                        <!-- <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">DropIt</a>
    ...
    <main class="wid70 wid100Mobile mx-auto p-4">
        ...
        <div class="wid50  wid50Mobile mx-auto">
            ...
            <div class="form-group m-3">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Banner Type <span class="required">*</span></label>

                <select type='text' id="bannertype" name='bannertype' class="form-select" aria-label="Default select example">
                    <option selected>Select banner type</option>
                    <option value="long">Long (width-> 120 * height -> 600) </option>
                    <option value="wide">wide (width-> 1349 * height -> 192)</option>
                    <option value="Home">Home (width-> 300 * height -> 600)</option>
                </select>

            </div>
            <div class="form-group m-3">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Uploader Name<span class="required">*</span></label>
        ...
        <div class="bgSocials p-2 my-4 rounded wid80 mx-auto">
            <img src="files/{{$ad->name}}" alt="" class="my-4 wid100">
            <div class="d-flex flex-wrap align-items-center ">
                <p class="bgSocials m-2 bgSocialBlueGrey p-1 rounded small "><span class="boldEight">Banner Type:</span> <br> {{$ad->bannertype}}</p>
                <p class="bgSocials m-2 bgSocialBlueGrey p-1 rounded small"><span class="boldEight">Banner Url:</span> <br> {{$ad->url}}</p>
                <div class="white p-2 rounded bgRed">
                    <a href="{{ route('dashboard.indexs') }}" onclick="event.preventDefault();
            document.getElementById(
              'delete-form-{{$ad->id}}').submit();">
                        Delete
                    </a>
                    </td>
                    <form id="delete-form-{{$ad->id}}" + action="{{route('banner.destroy', $ad->id)}}" method="post">
                        @csrf @method('DELETE')
                    </form>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#submit').click(function() {
            ...
            if (files.length > 0) {
                ...
                fd.append('bannertype', bannerType);
