                    ...
                    <div class=' wid70 wid100Mobile mx-auto'>
                        <div class='d-flex align-items-center justify-content-between'>
                            <div class='d-flex justify-content-center glow'>
                                <a href='https://stake.com/?c=KGSB' class='leftRa d-flex align-items-center' sytle='padding: 3px;' ><img src='" . asset('icons/stake.png') . "' alt='' class='iconSmallLg' style='padding: 5px;'></a>
                                <a href='https://stake.com/?c=KGSB' class='rightRa' style='color: white; background-color:red; font-size: 10px; font-weight: 700; white-space: nowrap; text-decoration: none; padding: 5px;'> Bet Now</a>
                            </div>
                        </div>
                    </td>
                </tr>
