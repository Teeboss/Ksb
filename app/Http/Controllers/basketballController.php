...
class basketballController extends Controller
{
    ...
    public static function loadLeagueGames($leagueId)
    {
        ...
        if ($responses == 'error') {
            ...
            <tr>
            <td colspan='8'>
            <p class=' errorMsgBg p-3 white boldSix mt-4 wid100 centerText d-block mx-auto' role='alert'>No data at the moment</p>
            </td>
            </tr>";
        } else {
            $gameUI = "";
    ...
    public static function fixturesGames($fixtureId)
    {
        ...
        curl_close($curl);
        if (!isset(json_decode($response)->response[0])) {
            echo "<p class=' errorMsgBg p-3 white boldSix mt-4 wid100 centerText d-block mx-auto' role='alert'>No data at the moment</p>";
        } else {
    ...
    public static function headTwoHead($homeId, $awayId)
    {
        ...
        // echo $response;
        if (!isset(json_decode($response)->response[0])) {
            $response .=  "<p class=' errorMsgBg p-3 white boldSix mt-4 wid100 centerText d-block mx-auto' role='alert'>No data at the moment</p>";
        } else {
